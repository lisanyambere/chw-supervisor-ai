...
| 4 — Supervisor frontend | **In progress** | Next.js 15 + Tailwind; SSE-streamed `/briefing`, live plan timeline, structured answer renderer, CHW detail drawer, localStorage persistence |
